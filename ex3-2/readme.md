این مثال براساس دیتاست سایت kaggle ایجاد شده است.دیتاست اطلاعات یک چاه منفرد را براساس داده های سایتKansas Geological Survey (http://www.kgs.ku.edu) استخراج شده است.
