این مثال براساس داده های تولید محصولات هیدروکربنی در کشورهای حاشیه خلیح فارس (GCC) از سال ۲۰۰۲ \یاده سازی شده است.
...
Direct use DIRECUSE Interproduct transfers IPTRANSF
